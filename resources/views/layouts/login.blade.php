        ...
        <section>
            ...
            <div class="panel panel-signin">
                <div class="panel-body">
                    ...
                    <div class="mb30"></div>
                    {!! Form::open(array('route' => 'login.attemp', 'method' => 'post', 'id' => 'login')) !!}
                    <div class="input-group mb15">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                         {!! Form::text('user',null, array('class' => 'form-control', 'placeholder' => 'Cedula' , 'id' => 'cedula', 'style' => 'padding: 12px;')) !!}
                    </div>
                    <div class="input-group mb15">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                        {!! Form::password('password', array('class' => 'form-control', 'placeholder' => 'Clave', 'id' => 'clave' , 'style' => 'padding: 12px;')) !!}
                    </div>
                    <div class="clearfix">
