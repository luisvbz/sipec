<div class="col-md-10 col-md-offset-1">
      <div class="panel panel-default">
        ...
        <div class="panel-footer">
          ...
          <form method="post" action="/participante/printRecord" target="_blank">
          <input type="hidden" name="_token" value="{{ csrf_token() }}" >
          <input type="hidden" name="abrev" v-bind:value="abrev">
          <button class="btn btn-success pull-right" type="submit" target="_blank">Imprimir <i class="fa fa-print" target="_blank"></i></button>
          </form>
        </div>
      </div>
    </div>